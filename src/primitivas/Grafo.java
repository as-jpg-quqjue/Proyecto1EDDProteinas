...
public class Grafo {
    ...
    if (cantidadInicial < 1) cantidadInicial = 1; // Mínimo razonable
    ...
    */
    ...
    if (a < 0 || b < 0 || a >= cantidadProteinas || b >= cantidadProteinas || a == b) {
        System.out.println("ADVERTENCIA: Índices inválidos para conexión");
        return;
    }
    matrizPeso[a][b] = peso;
    matrizPeso[b][a] = peso; // Grafo no dirigido
}
